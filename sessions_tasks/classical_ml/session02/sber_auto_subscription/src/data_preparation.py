...
Скрипт выполняет полный цикл подготовки данных:
    ...
    - формирует целевую переменную target на основе ga_hits
    - создает признаки модели на основе ga_sessions
    - не включает в финальную модель агрегаты по событиям всей сессии,
...
def prepare_dataset() -> pd.DataFrame:
    ...
    Порядок работы:
        ...
        3. Создает признаки из таблицы sessions
