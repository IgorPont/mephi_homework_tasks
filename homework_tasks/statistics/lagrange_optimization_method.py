...
Условие:
    ...
    поэтому при их использовании получаются разные издержки, зависящие от произведенных упаковок и
...
# Берем ту, которая совпадает с x_star
...
# -------------------------------
# ПОИСК ИСТИННОГО МАКСИМУМА НА ЦЕЛОЧИСЛЕННОЙ РЕШЕТКЕ
# -------------------------------
# По условию задачи x и y — целые часы. Значит, нужно проверить все пары (x, y), x>=0, y>=0, x+y=20.
# Это небольшая решетка из 21 точки, легко перебрать.
